...
function applyDefaultBiomesSystem() {
  ...
  const color = ["#466eab", "#ffffe6", "#dfbf9f", "#d4b996", "#cab48e", "#c3b088", "#ffff99",
                 "#d2a679", "#b3ff1a", "#4dff4d", "#00ff00", "#d5e7eb", "#0b9131" "#ffff66", "#e6ff66", "#ffcc33", 
                 ...
                 "#adc252", "#334d00", "#008000", "#003300"];
  const habitability = [0, 4, 5, 9, 10, 13, 7, 25, 49, 57, 62, 13, 16, 41, 82, 87, 99,
                        13, 16, 42, 83, 88, 100, 95, 12, 15, 39, 79, 83, 95, 90, 12, 15, 38, 77, 82, 94, 88, 83, 2, 12];
  ...
  const cost = [10, 198, 245, 219, 193, 193, 149, 25, 77, 67, 67, 132, 121,
