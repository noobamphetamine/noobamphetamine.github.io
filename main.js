...
function applyDefaultBiomesSystem() {
  ...
  const habitability = [0, 4, 5, 9, 10, 13, 7, 25, 49, 57, 62, 2, 12, 13, 16, 41, 82, 87, 99,
                        13, 16, 42, 83, 88, 100, 95, 12, 15, 39, 79, 83, 95, 90, 12, 15, 38, 77, 82, 94, 88, 83];
  const iconsDensity = [0, 1, 3, 4, 5, 6, 2, 10, 100, 110, 120, 3, 5, 11, 110, 120, 130, 4, 6,
                        15, 115, 125, 135, 145, 5, 7, 20, 120, 130, 140, 150, 4, 6, 60, 130, 140, 150, 150, 150, 0, 150];
  const icons = [
    {},
    {dune: 9, deadTree: 1},
    {grass: 1},
  ...
  const cost = [10, 198, 245, 219, 193, 193, 149, 25, 77, 67, 1000, 150, 67, 132, 121,
                19, 56, 56, 63, 143, 132, 21, 63, 63, 70, 77, 154, 143, 81, 70, 70, 77, 84, 176, 165, 95, 84, 84, 91, 98, 105]; // biome movement cost
  const biomesMartix = [
    // hot ↔ cold [>19°C; <-4°C]; dry ↕ wet
    new Uint8Array([33, 33, 33, 33, 26, 26, 26, 26, 19, 19, 19, 14, 13, 13, 6, 6, 6, 6 ,2, 2, 2, 2, 1, 1, 1, 1]),
    new Uint8Array([33, 34, 35, 35, 28, 27, 27, 27, 21, 20, 20, 15, 14, 14, 7, 7, 7, 7, 3, 3, 3, 2, 1, 1, 1, 1]),
